...
export default function Contact() {
  ...
  const handleEmailClick = () => {
    navigator.clipboard.writeText("maheshprayaga09@gmail.com");
    setCopied(true);
              ...
              {contactInfo.map((info) => {
                ...
                return (
                  <div
                    ...
                    className="group flex justify-between items-center border-b border-gray-200 py-4 transition-all hover:border-black cursor-pointer"
                  >
